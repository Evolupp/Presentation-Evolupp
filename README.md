...
### 1. Le Core Système (Projet Majeur)
* Écriture du bootloader et gestion de la mémoire en code natif.
* Conception d'un noyau indépendant et ultra-léger.
* Architecture système modulaire.

### 2. Solutions Applicatives & Utilitaires
* Création d'applications résolvant les problématiques concrètes du quotidien.
* Développement de logiciels légers pour soutenir la digitalisation des petites sociétés et structures locales.

### 3. Evolupp SDK (Kit de Développement)
* Fournir aux développeurs des outils simples et accessibles pour coder sur notre écosystème.
* Support natif pour les scripts légers (Python) et les technologies d'interface modernes.
